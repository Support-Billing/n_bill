        ...
        if($request->ajax())
        {
            ...
            foreach ($data_result as $value) {
                ...
                $rows[] = array(
                    ...
                    $value->jam, // Jam
                    $value->sourceNoOut, // No. Asal
                    $value->IP,  //IP
                    $value->destno, // No. Tujuan
                    $value->WaktuReal, // Waktu Real
                    $value->Duration, // Waktu Ditagih
                    $value->DurationMin, // Tarif/Menit
                    $value->TotalPrice  // Biaya
                );
