...
use App\Models\sum\ElapsedTime;
use DB;

class ElapsedTimeController extends Controller
{

    private $_access_menu;
    private $_page_title = 'Elapsedtime';
    private $_url_data = 'elapsedtime';
    private $_id_role = '';
    ...
    public function index()
    {
        ...
        {
            return view('monitoring.elapsedtime.index', [
    ...
    public function load(Request $request)
    {
        if($request->ajax())
        {
            ...
            $data_result = elapsedtime::where($cond)->offset($offset)->limit($limit)->get();
            $data_count = elapsedtime::where($cond)->count();
