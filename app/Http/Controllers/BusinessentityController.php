...
{
    private $_page_title = 'Business Entity';
    private $_url_data = 'businessentity';
    ...
    public function index()
    {
        ...
        {
            return view('master.businessentity.index', [
    ...
    public function create()
    {
        ...
        if ( !empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' )
        {
            return view('master.businessentity.create', [
                'page_title' => $this->_page_title
            ]);
        }else{
            // return abort(404);
    ...
    public function edit(string $id)
    {
        if ( !empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest' )
        {
            ...
            return view('master.businessentity.edit', [
                'page_title' => $this->_page_title,
                'data' => $businessentity
            ]);
        }else{
    ...
    public function load(Request $request)
    {
        if($request->ajax())
        {
            ...
            foreach ($data_result as $value) {
                $id = $value->id;
                $linkdelete =  url('businessentity/'.$id);
                ...
                $action .= "<a href='javascript:void(0);' 
                    ...
                    data-module='businessentity' 
                    data-url='businessentity/{$id}/edit' 
