            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        <form action="{{route('bank.store')}}" id="finput" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        @csrf
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="acc" value="" id="input_acc" class="form-control">
                                    <span id="error_acc"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="code" value="" id="input_code" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="accname" value="" id="input_accname" class="form-control">
                                    <span id="error_accname"></span>
                                </div>
                            </div>
