            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        <form action="{{route('syssetting.update', [$data->id])}}"  id="finput" class="form-horizontal" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            @csrf
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    <input type="text" name="key" value="{{$data->key}}" class="form-control">
                                </div>
