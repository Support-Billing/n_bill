            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        <form action="{{route('prefixgroup.update', [$data->idx])}}"  id="finput" class="form-horizontal" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="name" value="{{$data->nama}}" id="input_name" class="form-control">
                                    <span id="error_name"></span>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label class="col-md-2 control-label">Telkom Price <sup>*</sup></label>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-money"></i></span>
                                        <input type="text" name="telkomPrice" value="{{$data->telkomPrice}}" id="input_telkomPrice" class="form-control">
                                    </div>
                                    <span id="error_telkomPrice"></span>
                                </div>
                            </div>
