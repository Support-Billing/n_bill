            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        <form action="{{route('prefixgroup.store')}}" id="finput" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        @csrf
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="telkomPrice" value="" id="input_telkomPrice" class="form-control">
                                    </div>
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        var pageFunction = function () {
            $('input[name=telkomPrice]').numeric();
