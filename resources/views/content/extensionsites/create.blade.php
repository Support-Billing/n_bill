            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        <form action="{{route('extension.store')}}" id="finput" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                            @csrf
                            <fieldset>

                                <div class="row form-group smart-form">
                                    <label class="col col-2 control-label">IP Adress <sup>*</sup></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="contact1" value="" class="form-control">
                                        <span id="error_name"></span>
                                    </div>
                                </div>
