<html>
    ...
    <body>
        ...
        <div class="modal-body">
            <form action="{{route('project.store_prefix', $projectID)}}" id="finput" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                @csrf
                <fieldset>
                    <div class="row form-group smart-form">
                        <label class="col-md-4 control-label">Prefix Number <sup>*</sup></label>
                        <section class="col col-5">
                            <label class="input"> 
                                <input type="text" name="prefixNumber" id="input_prefixNumber" class="form-control">
