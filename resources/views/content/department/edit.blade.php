            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        <form action="{{route('department.update', [$data->id])}}"  id="finput" class="form-horizontal" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
                            @csrf
	                        ...
	                        <fieldset>
	                            <div class="form-group">
	                                ...
	                                <div class="col-md-3">
	                                    <input type="text" name="name"  id="input_xxx" value="{{$data->name}}" class="form-control">
	                                </div>
	                            </div>
