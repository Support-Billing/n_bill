                    ...
                    <div class="widget-body">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="col-md-2 no-padding margin-right-5">
                                        <input type="text" name="no_lokasi_kerja" value="" id="input_name" id="id_lokasi_kerja" class="form-control" readonly="readonly">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea name="address" cols="40" rows="10" class="form-control" id="input_address" ></textarea>
