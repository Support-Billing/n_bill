            ...
            <fieldset>
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="menu_name" value="" id="input_menu_name" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <div class="input-group">
                            ...
                            <input type="text" name="menu_url" value="" id="input_menu_url" class="form-control">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="menu_icon" value="" id="input_menu_icon" class="form-control">
                    </div>
                </div>
