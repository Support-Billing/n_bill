            ...
            <div class="jarviswidget" id="wid-id-0" 
                ...
                <div>
                    ...
                    <div class="widget-body">
                        <form action="{{route('customergroup.store')}}" id="finput" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        @csrf
                        <fieldset>
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        var pageFunction = function () {
            $('input[name=tarifPerMenit]').numeric();
            $('input[name=startRange]').numeric();
            $('input[name=endRange]').numeric();
