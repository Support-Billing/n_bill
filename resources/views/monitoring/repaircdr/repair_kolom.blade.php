    ...
    <body>
        ...
        <div class="modal-body">
            <div class="alert alert-warning fade in" style="margin-bottom:0" >
                ...
                Informasi Repair CDR.
            </div>
<pre>
<code class="javascript">
Repair CDR adalah pengubahan ulang data kolom CDR yang berfokus pada 9 kolom utama. 
9 kolom tersebut harus didapatkan agar data CDR dari server MERA, VOS, ELASTIX dan ASTERISK memiliki relasi dengan <br />management master/setting data Customer atau dengan Supplier,
...
<pre id="reportParser" style="height: 150px;visibility:hidden" ></pre>
            ...
            <form action="{{route('repaircdr.reason_kolom', 'reportParser')}}" id="fCalculate" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            @csrf
        ...
        <div class="modal-footer">
            ...
            <a href="javascript:void(0);" id="mybuttonStopCalculate" class="btn btn-labeled bg-color-magenta" disabled="disabled" ><span class="btn-label"><i class="glyphicon glyphicon-refresh"></i></span> Stop Repair CDR</a>
            
            <a href="javascript:void(0);" id="mybuttonRunCalculate" class="btn btn-labeled btn-success" onclick="my_form.submit('#fCalculate')"><span class="btn-label"><i class="glyphicon glyphicon-refresh"></i></span> Repair CDR</a>
        </div>
        <script type="text/javascript">
            ...
            function callLooping() {
                ...
                var link = "{{route('repaircdr.reason_kolom', 'reportParser')}}"; 
                var dataType = 'json'; 
                var dataSend = {};
            ...
            function nextload(call_back) {
                ...
                if(checkFirstData == ''){
                    ...
                    $('#reportParser').append("Start Repair Data : "+formattedDate);
                }
                // untuk manage tombol
                ...
                if (stopCalculate == "No") { // kondisi masih mau menjalankan looping
                    ...
                    if (call_back == "Yes") {
                        ...
                        $('#reportParser').append('<br/>Data Repair CDR Selesai.');
                    ...
                    // in prosess
                    // stop looping and Proses selesai
                    $('#reportParser').append('<br/>Anda melakukan stop Repair CDR.');
                    $('#mybuttonRunCalculate').removeAttr('disabled');
                    $("#mybuttonStopCalculate").attr('disabled', 'disabled');
                    $('#reportParser').append("<br/>End Calculate : "+formattedDate);
                    $("#stopCalculate").val("No");
