                    ...
                    <div class="widget-body no-padding">
                        ...
                        @if($import_otoritas_modul)
                            <div class="padding-5 border-bottom-1">
                                ...
                                <a 
                                    href='repaircdr/repaircdr/repair_kolom' 
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%" 
                            ...
                            <thead>                         
                                <tr>
                                    ...
                                    <th data-hide="delicious"><i class="fa fa-fw fa-delicious text-muted hidden-md hidden-sm hidden-xs"></i> Problem</th>
                                    <th data-hide="delicious"><i class="fa fa-fw fa-delicious text-muted hidden-md hidden-sm hidden-xs"></i> Date</th>
