                ...
                <div>
                    ...
                    <div class="widget-body no-padding">
                                    ...
                                    <div class="row">
                                        <section class="col col-4">
                                            <label class="input">
                                                ...
                                                <!-- <select name="FolderName" id="input_FolderName" class="select2 select2-offscreen" placeholder="" tabindex="-1" title="">
                                                    <option value="" selected="selected">-- Choose Folder Name --</option>
                                                    @foreach ($results as $keyf => $result)
                                                        <option value="{{ $result->FolderName }}">{{ $result->FolderName }}</option>
                                                    @endforeach
                                                </select> -->
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%"
                                data-source="{{url('folderserverload')}}"
                                data-filter="#filter_table" >
                            <thead>
                                <tr>
                                    <th data-hide="delicious">No</th>
                                    <th data-hide="delicious"><i class="fa fa-fw fa-delicious text-muted hidden-md hidden-sm hidden-xs"></i> Folder Name</th>
                                    <th data-hide="delicious"><i class="fa fa-fw fa-delicious text-muted hidden-md hidden-sm hidden-xs"></i> Jumlah File</th>
                                    <th data-hide="delicious"><i class="fa fa-fw fa-delicious text-muted hidden-md hidden-sm hidden-xs"></i> Jumlah Row CSV</th>
                                    <th data-hide="delicious"><i class="fa fa-fw fa-delicious text-muted hidden-md hidden-sm hidden-xs"></i> Detail Folder</th>
                                </tr>
                            </thead>
                        </table>
