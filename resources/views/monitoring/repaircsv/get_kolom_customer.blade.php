...
Repair CSV Parser Customer adalah pengecekan ulang data kolom CSV yang berfokus pada data yg berhubungan dengan Customer. 
Kolom tersebut harus didapatkan agar data csv dari server MERA, VOS, ELASTIX dan ASTERISK memiliki relasi dengan <br />data Customer,
Adapun kolom kolom tersebut adalah sebagai berikut :
1. destNoCust
2. destNoCustPrefix 
3. idxCustomer
4. idxCustomerIP
5. idxCustomerIPPrefix
6. sourceIPFixed
7. sourceIPValue
</code>
</pre>
...
<pre id="reportParser" style="height: 150px;visibility:hidden" ></pre>
            ...
            <form action="{{route('repaircsvparser.update_csv_customer', 'reportParser')}}" id="fCalculate" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
            @csrf
        ...
        <div class="modal-footer">
            ...
            <a href="javascript:void(0);" id="mybuttonStopCalculate" class="btn btn-labeled bg-color-magenta" disabled="disabled" ><span class="btn-label"><i class="glyphicon glyphicon-refresh"></i></span> Stop Repair CSV to Data Customer</a>
            
            <a href="javascript:void(0);" id="mybuttonRunCalculate" class="btn btn-labeled btn-success" onclick="my_form.submit('#fCalculate')"><span class="btn-label"><i class="glyphicon glyphicon-refresh"></i></span> Repair CSV to Data Customer</a>
        </div>
        <script type="text/javascript">
            ...
            function callLooping() {
                ...
                var link = "{{route('repaircsvparser.update_csv_customer', 'reportParser')}}"; 
                var dataType = 'json'; 
                var dataSend = {};
