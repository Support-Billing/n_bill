...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="img/logo-pale.png" alt="Quiros"> </span>
    ...
    <div class="pull-right">
        ...
        <div id="logout" class="btn-header transparent pull-right">
            <span> 
                ...
                onclick="my_form.logout('logout-form')"
                >
                    <i class="fa fa-sign-out"></i>
                </a>

                <!-- <a href="{{ route('logout') }}" title="Sign Out" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <i class="fa fa-sign-out"></i>
                </a>  -->
