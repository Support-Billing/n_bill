                    ...
                    <div class="widget-body no-padding">
                        ...
                        @if($import_otoritas_modul)
                            <div class="padding-5 border-bottom-1">
                                <a href="{{route('download_reportbiayaproject', 'active')}}" id="download_data" class="btn btn-labeled bg-color-greenLight text-white" >
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%" 
                               data-source="{{url('reportbiayaprojectload')}}"
                                data-paginate="500"
                               data-filter="#filter_table">
                            <thead>                         
                                <tr>
                                    <th data-hide="phone">No</th>
                                    <th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Prefix</th>
                                    <th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Project</th>
                                    ...
                                    <!-- <th data-class="expand"><i class="fa fa-fw fa-money text-muted hidden-md hidden-sm hidden-xs"></i> Action</th> -->
                                </tr>
                            </thead>
                        </table>
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        ...
        //                 return $('<span class="select2-selection__choice">' + s.text + '</span>');
        //             });
        //         }
        ...
        //             return result.text;
        //         }
        //         var checkbox = $('<span><input type="checkbox" class="mr-2"> ' + result.text + '</span>');
        //         return checkbox;
        //     }
        // });
