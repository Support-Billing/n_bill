...
3. Excel yang dapat di download dalam waktu harian atau detil informasi Data CDR dari Summary terkait.
                        ...
                        @if($import_otoritas_modul)
                            <div class="padding-5 border-bottom-1">
                                <a href="{{route('download_reportcdrdetil', $urlData)}}" class="btn btn-labeled bg-color-greenLight" >
                        ...
                        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%" 
                            ...
                            <thead>
                                ...
                                <tr>
                                    <th colspan='10' class='text-center' > {{$dateStart}} - {{$dateEnd}} </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                ...
                                @foreach ($results as $key => $val)
                                    <tr>
                                        ...
                                        <!-- WaktuTagih / Duration -->
                                        <td data-class="expand" class="text-right" >{{$val->custTime}}</td>
                                        ...
                                        <?php
                                            ...
                                            if($val->custPrice != Null){
                                                ...
                                                $get_custPrice = $getMenit_custTimeCDR * $val->custPrice;
                                            }
                                        ?>
